...
//        pen.drawPolygon(xPoly, yPoly, numberofpoints);
		...
		//----------------------------Test (Draw Door)---------------------
		pen.setColor(Color.black); // a color constant
		pen.drawString("Door", 500, 500);
		pen.setColor(Color.black); // a color constant
		pen.drawRect(500, 500, 200, 300);
		pen.setColor(Color.CYAN);
		pen.fillRect(500, 500,200, 300);
		pen.setColor(Color.black);
		pen.fillOval(510, 650, 20, 20);
